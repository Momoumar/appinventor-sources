...
(define *debug* #t)
;(define MysteryComp (ReplFormMos:loadAndInstantiate  "com.google.appinventor.components.runtime.MysteryComp" container))
  ...
  (syntax-rules ()
    ((_ container component-type component-name)
     (begin 
       ...
       ;(android-log (format #f "Calling ** add-component    ~A of type ~A  " component-name component-type))
       (if *this-is-the-repl*
...
(define (add-component-within-repl container-name component-type component-name init-props-thunk)
  (android-log (format #f "Calling ** add-component-within-repl  ~A of type ~A  " component-name component-type))
...
(define (in-ui blockid promise)
  (set! *this-is-the-repl* #t)          ;; Should do this somewhere else...
    (android-log (format #f "Calling **  in-ui"))
  (*ui-handler*:post
   (runnable (lambda ()
...
(define (send-to-block blockid message)
  (android-log (format #f "Calling **  send-to-block "))
...
(define (set-form-name form-name)
  (android-log (format #f "Calling ** set-form-name "))
...
(define (init-runtime)
(android-log (format #f "Calling **init-runtime  "))
  (set-this-form)
...
(define (set-this-form)
  (android-log (format #f "Calling ** set-this-form "))
